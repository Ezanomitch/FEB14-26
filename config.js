...
const CONFIG = {
    ...
    valentineName: "Julia-Rose Aka JROSE AKA JR-15",
    ...
    questions: {
        first: {
            ...
            secretAnswer: "I don't like you, I love you & you are the GOAT! 🐐"           // Secret hover message
        },
        second: {
        ...
        third: {
            text: "My Nigga Will you be my Valentine on February 14th, 2026? 🌹", // The big question!
            yesBtn: "Yes!",                                             // Text for "Yes" button
            noBtn: "No"                                                 // Text for "No" button
        }
    },
    ...
    loveMessages: {
        extreme: "WOAHHH NAAA 😘",  // Shows when they go past 5000%
